 ...
 * @author Hp
 */
public class FourQueensController extends MainClassController implements Initializable {

    /**
     * Initializes the controller class.
     */
    backTracking queensSet = new backTracking(4);
...
//    ObservableList<String> list = FXCollections.observableArrayList("1", "2", "3", "4", "5");
    ArrayList<ImageView>[][] ivList = new ArrayList[4][4];
