 ...
 * @author Hp
 */
public class NineQueensController implements Initializable {

    /**
     * Initializes the controller class.
     */
    // Integer arr[][] = new Integer[9][9];
    backTracking queenSet = new backTracking(9);
    Integer[][] matrix1 = new Integer[9][9];
    String k;
...
//    ObservableList<String> list=FXCollections.observableArrayList("1","2","3","4","5");
    ArrayList<ImageView>[][] ivList = new ArrayList[9][9];
