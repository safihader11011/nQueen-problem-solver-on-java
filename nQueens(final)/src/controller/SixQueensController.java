 ...
 * @author Hp
 */
public class SixQueensController extends MainClassController implements Initializable {

    /**
     * Initializes the controller class.
     */
    backTracking queensSet = new backTracking(6);
    Integer[][] matrix1 = new Integer[6][6];
    String k;
...
//    ObservableList<String> list = FXCollections.observableArrayList("1", "2", "3", "4", "5");
    ArrayList<ImageView>[][] ivList = new ArrayList[6][6];
