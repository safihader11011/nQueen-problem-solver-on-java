 ...
 * @author Hp
 */
public class TenQueensController implements Initializable {

    backTracking queenSet = new backTracking(10);
    Integer[][] matrix1 = new Integer[10][10];
    String k;
    ArrayList<int[][]> ab = new ArrayList<>();
    boolean genObject = false;
    int iterationsNum = 0;
    int totalIterations = 0;
    ArrayList<ImageView>[][] ivList = new ArrayList[10][10];
    ...
    @FXML
    private SplitPane pane91;

    @FXML
    private ImageView IV91;

    @FXML
    private SplitPane pane93;

    @FXML
    private ImageView IV93;

    @FXML
    private SplitPane pane94;

    @FXML
    private ImageView IV94;

    @FXML
    private SplitPane pane95;

    @FXML
    private ImageView IV95;

    @FXML
    private SplitPane pane96;

    @FXML
    private ImageView IV96;

    @FXML
    private SplitPane pane97;

    @FXML
    private ImageView IV97;

    @FXML
    private SplitPane pane98;

    @FXML
    private ImageView IV98;

    @FXML
    private SplitPane pane92;

    @FXML
    private ImageView IV92;

    @FXML
    private SplitPane pane19;

    @FXML
    private ImageView IV19;

    @FXML
    private SplitPane pane29;

    @FXML
    private ImageView IV29;

    @FXML
    private SplitPane pane39;

    @FXML
    private ImageView IV39;

    @FXML
    private SplitPane pane49;

    @FXML
    private ImageView IV49;

    @FXML
    private SplitPane pane59;

    @FXML
    private ImageView IV59;

    @FXML
    private SplitPane pane69;

    @FXML
    private ImageView IV69;

    @FXML
    private SplitPane pane79;

    @FXML
    private ImageView IV79;

    @FXML
    private SplitPane pane89;

    @FXML
    private ImageView IV89;

    @FXML
    private SplitPane pane99;

    @FXML
    private ImageView IV99;

    @FXML
    private SplitPane pane101;

    @FXML
    private ImageView IV101;

    @FXML
    private SplitPane pane102;

    @FXML
    private ImageView IV102;

    @FXML
    private SplitPane pane103;

    @FXML
    private ImageView IV103;

    @FXML
    private SplitPane pane104;

    @FXML
    private ImageView IV104;

    @FXML
    private SplitPane pane105;

    @FXML
    private ImageView IV105;

    @FXML
    private SplitPane pane106;

    @FXML
    private ImageView IV106;

    @FXML
    private SplitPane pane107;

    @FXML
    private ImageView IV107;

    @FXML
    private SplitPane pane108;

    @FXML
    private ImageView IV108;

    @FXML
    private SplitPane pane109;

    @FXML
    private ImageView IV109;

    @FXML
    private SplitPane pane1010;

    @FXML
    private ImageView IV1010;

    @FXML
    private SplitPane pane910;

    @FXML
    private ImageView IV910;

    @FXML
    private SplitPane pane810;

    @FXML
    private ImageView IV810;

    @FXML
    private SplitPane pane710;

    @FXML
    private ImageView IV710;

    @FXML
    private SplitPane pane610;

    @FXML
    private ImageView IV610;

    @FXML
    private SplitPane pane510;

    @FXML
    private ImageView IV510;

    @FXML
    private SplitPane pane410;

    @FXML
    private ImageView IV410;

    @FXML
    private SplitPane pane310;

    @FXML
    private ImageView IV310;

    @FXML
    private SplitPane pane210;

    @FXML
    private ImageView IV210;

    @FXML
    private SplitPane pane110;
            ...
            if (matrix1 == null) {
                ...
                for (int j = 0; j < queenSet.getN(); j++) {
                    for (int i = 0; i < queenSet.getN(); i++) {
                        ...
                        } else if ((Integer.toString(j) + Integer.toString(i)).equalsIgnoreCase(s.get(8))) {
                            track.get(8).setImage(null);
                            //IV21.setImage(null);
                            ivList[j][i].get(0).setImage(img);
                            track.remove(8);
                            track.add(8, ivList[j][i].get(0));
                        } else if ((Integer.toString(j) + Integer.toString(i)).equalsIgnoreCase(s.get(9))) {
                            track.get(9).setImage(null);
                            //IV21.setImage(null);
                            ivList[j][i].get(0).setImage(img);
                            track.remove(9);
                            track.add(9, ivList[j][i].get(0));
                        }
                    }
                }
            }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ivList[8][7].add(IV98);
        ivList[8][8].add(IV99);
        ivList[8][9].add(IV910);

        ivList[9][0].add(IV101);
        ivList[9][1].add(IV102);
        ivList[9][2].add(IV103);
        ivList[9][3].add(IV104);
        ivList[9][4].add(IV105);
        ivList[9][5].add(IV106);
        ivList[9][6].add(IV107);
        ivList[9][7].add(IV108);
        ivList[9][8].add(IV109);
        ivList[9][9].add(IV1010);
